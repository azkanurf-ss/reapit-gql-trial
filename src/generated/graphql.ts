...
export type GetAllOfficeNameQueryVariables = Exact<{ [key: string]: never }>

export type GetAllOfficeNameQuery = {
  __typename?: 'Query'
  GetOffices: {
    __typename?: 'PagedResultOfficeModel'
    ...
    _embedded?: Array<{ __typename?: 'OfficeModel'; id?: string | null; name?: string | null }> | null
  }
}

export const GetAllOfficeNameDocument = `
    query getAllOfficeName {
  GetOffices(pageSize: 80, pageNumber: 1) {
    _embedded {
      id
      name
    }
    ...
    `
export const useGetAllOfficeNameQuery = <TData = GetAllOfficeNameQuery, TError = unknown>(
  client: GraphQLClient,
  variables?: GetAllOfficeNameQueryVariables,
  options?: UseQueryOptions<GetAllOfficeNameQuery, TError, TData>,
  headers?: RequestInit['headers'],
) =>
  useQuery<GetAllOfficeNameQuery, TError, TData>(
    variables === undefined ? ['getAllOfficeName'] : ['getAllOfficeName', variables],
    fetcher<GetAllOfficeNameQuery, GetAllOfficeNameQueryVariables>(
      client,
      GetAllOfficeNameDocument,
      variables,
      headers,
    ),
    options,
